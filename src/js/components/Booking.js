...
export class Booking {
  ...
  render(element) {
    ...
    this.dom.datePicker = document.querySelector(select.widgetsNew.datePicker.wrapper);
    this.dom.datePicker = document.querySelector(select.widgetsNew.hourPicker.wrapper);
  }
